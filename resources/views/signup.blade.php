        ...
        <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
            <div class="card-sigin">
                <div class="mb-5 d-flex">
                    <a href="index.php" class="header-logo"><img src="images/brand-logos/desktop-logo.png"
                        ...
                        <form action="{{route('addUser')}}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label">Confirm Password</label> <input class="form-control"
                                    placeholder="Enter your password" type="password" name="cpassword">
                                    <span class="text-danger">
                            ...
                            <button type="submit"  class="btn btn-primary btn-block w-100" value="Create Account" name="signup">Create Account</button>
                            <div class="row mt-3">
                                <div class="col-sm-6">
