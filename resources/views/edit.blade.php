                        ...
                        <div class="card-body py-5">
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-12 my-4">
                                    ...
                                    <input type="text" class="form-control rounded-0" id="input-noradius" placeholder="Name" value="{{$user->name}}" name="name">
                                </div>
                                <div class="col-xl-12 my-4">
                                    <label for="input-rounded" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="input-rounded" placeholder="Email" value="{{$user->email}}" name="email">
                                </div>
