...
<div class="row">
    <div class="col-md-12">
        @if(session()->has('createuser') || session('updated') || session('deleted'))
    ...
    <div class="card custom-card">
        <div class="card-header justify-content-between">
            <div class="card-title">
             ...
             <div class="create">
                <a  href="{{route('createUserPage')}}">Create User <img src="/icon-fonts/bootstrap-icons/icons/icons/person-fill-add.svg" alt="Create New Profile" ></a>    
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="hstack gap-1 flex-wrap justify-content-center">
                                    <a href="{{route('edit.Page', $user->id)}}" class="text-info fs-14 lh-1"><i
                                            class="ri-edit-line"></i></a>
                                    <a href="{{route('delete', $user->id)}}" class="text-danger fs-14 lh-1"><i
