                        ...
                        <div class="card-body py-5">
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-12 my-4">
                                    ...
                                    <input type="text" class="form-control rounded-0 @error('name') is-invalid @enderror" id="input-noradius" placeholder="Name"  name="name" value="{{old('name')}}">
                                ...
                                <div class="col-xl-12 my-4">
                                    ...
                                    <input type="text" class="form-control rounded-0 @error('email') is-invalid @enderror" id="input-noradius" placeholder="Email" name="email" value="{{old('email')}}">
                                    <span class="text-danger">
                                        @if($errors->has('email'))
                                        @error('email')
                                            {{$message}}
                                ...
                                <div class="col-xl-12 my-4">
                                    <label for="input-rounded" class="form-label">Password</label>
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="input-rounded" placeholder="Password"  name="password" value="">
                                    <span class="text-danger">
